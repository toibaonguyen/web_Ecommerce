    ...
    <>
      <div className={cx('container')}>
        <div className={cx('styled-account-layout')}>
          ...
          <div className={cx('styled-account-inner')}>
            <div className={cx('styled-wrapped')}>
              ...
              <div className={cx('container-help-center')}>
                ...
                <div className={cx('styled-list1')}>
                  ...
                  <div className={cx('styled-item')}>
                    ...
                    <button className={cx('item-action')}>
                      Tạo đơn yêu cầu
                    </button>
                    <p className={cx('item-description')}>
                ...
                <div className={cx('styled-list2')}>
                  ...
                  <div className={cx('styled-item')}>
                    ...
                    <p className={cx('section-description')}>
                      Chính sách của các dịch vụ và chương trình dành cho khách
                      hàng Tiki
                    </p>
                    <a
                      className={cx('section-cta')}
                  ...
                  <div className={cx('styled-item')}>
                    ...
                    <p className={cx('section-description')}>
                      Quy chế hoạt động và chính sách của sàn thương mại điện tử
                      Tiki
                    </p>
                    <a
                      className={cx('section-cta')}
