...
function OrderDetail() {
  ...
  useEffect(() => {
    let fp = order.ordersAmount + 640000;
    setFinalPrice(fp);
  }, []);
  return (
    <div className={cx("order-detail-wrapper")}>
      <div className={cx("heading")}>
        <span>Chi tiết đơn hàng #648900318</span>
        <span className={cx("split")}>-</span>
        <span className={cx("status")}>Huỷ</span>
      </div>
      <div className={cx("created-date")}>
        Ngày đặt hàng: {order.diliveryDate}
      </div>
      <div className={cx("order-infor")}>
        <div className={cx("order-address")}>
          <div className={cx("title")}>Địa chỉ người nhận</div>
          <div className={cx("content")}>
            <p className={cx("name")}>Vũ Thị Khánh Ngọc</p>
            <p className={cx("address")}>
              <span>Địa chỉ: </span>thọ trung, xuân thọ, xuân lộc, đồng nai, Xã
              Xuân Thọ, Huyện Xuân Lộc, Đồng Nai, Việt Nam
            </p>
            <p className={cx("phone")}>
              <span>Điện thoại: </span>0584618462
            </p>
          </div>
        </div>
        <div className={cx("order-delivery")}>
          ...
          <div className={cx("content")}>
            ...
            <p>Giao thứ 5, trước 19h, 09/11</p>
            <p>Được giao bởi Đầm YuRin</p>
      ...
      <table className={cx("order-products")}>
        <thead>
          <tr>
            <th>Sản phẩm</th>
            <th>Giá</th>
            ...
            order.orderProducts.map((item, index) => {
              return (
                <tr key={index}>
                    ...
                    <div className={cx("product-item")}>
                      ...
                      <div className={cx("product-info")}>
                        <a
                          ...
                          href="/product-p104050175.html?spid=192668956"
                        >
                          {item.productName}
                        </a>
                        <p className={cx("product-seller")}>
                          Cung cấp bởi{" "}
                          <a href="/cua-hang/dam-yurin">{item.productStore}</a>
                        </p>
                        <p className={cx("product-sku")}>
                          Sku: {item.skuNumber}
                        </p>
                  ...
                  <td className={cx("quantity")}>{item.productQuantity}</td>
                  <td className={cx("discount-amount")}>0 ₫</td>
                  <td className={cx("raw-total")}>
        ...
        <tfoot>
          <tr>
            ...
            <td>{currencyFormat(order.ordersAmount)}</td>
          </tr>
          <tr>
            <td colspan="4">
          ...
          <tr>
            ...
            <td>
              <span className={cx("sum")}>
                {finalPrice ? currencyFormat(finalPrice) : ""}
              </span>
            </td>
          </tr>
        </tfoot>
      </table>
      <a className={cx("view-list-order")} href="/sales/order/history">
...
OrderDetail.getLayout = (page) => <CustomerLayout>{page}</CustomerLayout>;
