...
function AccountDetail() {
  return (
    <div className={cx("account-detail-wrapper")}>
                ...
                <div className={cx("form-info")}>
                  ...
                  <div className={cx("form-name")}>
                    <div className={cx("form-control")}>
                      <label className={cx("input-label")}>Họ &amp; Tên</label>
                      <div>
                    ...
                    <div className={cx("form-control")}>
                      <label className={cx("input-label")}>Nickname</label>
                      <div>
                        <div className={cx("styled-input")}>
                          <input
                            className={cx("input")}
          ...
          <div className={cx("info-right")}>
            ...
            <div className={cx("styled-list-item")}>
              <div className={cx("list-item")}>
                ...
                <div className={cx("status")}>
                  <span></span>
                  <button className={cx("button-active")}>Cập nhật</button>
                </div>
              </div>
              <div className={cx("list-item")}>
                <div className={cx("info")}>
            ...
            <div className={cx("styled-list-item")}>
              ...
              <div className={cx("list-item")}>
                ...
                <div className={cx("status")}>
                  <span></span>
                  <button className={cx("button-active")}>Thiết lập</button>
                </div>
              </div>
            </div>
            ...
            <div className={cx("styled-list-item")}>
              <div className={cx("list-item")}>
                ...
                <div className={cx("status")}>
                  <span></span>
                  <button className={cx("button-active")}>Liên kết</button>
                </div>
              </div>
              <div className={cx("list-item")}>
                <div className={cx("info")}>
...
AccountDetail.getLayout = (page) => (
  <CustomerLayout selectedNav={"account"}>{page}</CustomerLayout>
);
