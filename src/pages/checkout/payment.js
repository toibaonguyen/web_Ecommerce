                ...
                <div className={cx("deliver-item")}>
                  <div className={cx("delivery-timestamp")}>
                    <div className={cx("package-title")}>
                      ...
                      />
                      Gói 1: Giao thứ 2, trước 19h, 23/10
                    </div>
                  </div>
                  <div className={cx("left-content")}>
                    ...
                    <div className={cx("package-item-list")}>
                      <div>
                        <div className={cx("package-item")}>
                          <div className={cx("item-icon")}>
                            <img
                              src="https://salt.tikicdn.com/cache/96x96/ts/product/ba/2e/bd/2c888334362a4a21af988aa4cf1d2d37.jpg"
                              alt="icon"
                              width="48"
                              height="48"
                              srcSet="https://salt.tikicdn.com/cache/96x96/ts/product/ba/2e/bd/2c888334362a4a21af988aa4cf1d2d37.jpg"
                          ...
                          <div className={cx("item-info")}>
                            <div className={cx("item-info__first-line")}>
                              <span
                                ...
                                title="Set bộ đùi mặc nhà dành cho nữ, đồ bộ thun cotton mặc nhà-DUIHOA - 04 - M"
                              >
                                Set bộ đùi mặc nhà dành cho nữ, đồ bộ thun
                                cotton mặc nhà-DUIHOA - 04 - M
                              </span>
                            </div>
                      ...
                      <div>
                        <div className={cx("package-item")}>
                          <div className={cx("item-icon")}>
                            <img
                              src="https://salt.tikicdn.com/cache/96x96/ts/product/fa/1d/33/47edaa8f754e1c81d0b4ed4f7a5fb20a.png"
                              alt="icon"
                              width="48"
                              height="48"
                              srcSet="https://salt.tikicdn.com/cache/96x96/ts/product/fa/1d/33/47edaa8f754e1c81d0b4ed4f7a5fb20a.png"
                              className="WebpImg__StyledImg-sc-h3ozu8-0 fWjUGo"
                            />
                          </div>
                          <div className={cx("item-info")}>
                            <div className={cx("item-info__first-line")}>
                              <span
                                className={cx("item-info__product-name")}
                                title="iPhone 15 Pro Max 512GB Titan Đen"
                              >
                                iPhone 15 Pro Max 512GB Titan Đen
                              </span>
                            </div>
                            <div className={cx("item-info__second-line")}>
                              <div className={cx("item-info__qty")}>SL: x1</div>
                      ...
                      <div>
                        <div className={cx("package-item")}>
                          <div className={cx("item-icon")}>
                            <img
                              src="https://salt.tikicdn.com/cache/96x96/ts/product/40/5e/eb/4dcee6ceebbea004a14f212db4182b18.png"
                              alt="icon"
                              width="48"
                              height="48"
                              srcSet="https://salt.tikicdn.com/cache/96x96/ts/product/40/5e/eb/4dcee6ceebbea004a14f212db4182b18.png"
                              className="WebpImg__StyledImg-sc-h3ozu8-0 fWjUGo"
                            />
                          </div>
                          <div className={cx("item-info")}>
                            <div className={cx("item-info__first-line")}>
                              <span
                                className={cx("item-info__product-name")}
                                title="Apple iPhone 14 128GB Tím"
                              >
                                Apple iPhone 14 128GB Tím
                              </span>
                            </div>
                            <div className={cx("item-info__second-line")}>
                              <div className={cx("item-info__qty")}>SL: x1</div>
                  ...
                  <div className={cx("delivery-timestamp")}>
                    <div className={cx("package-title")}>
                      <img
                        ...
                        src="https://salt.tikicdn.com/ts/upload/ad/b7/93/7094a85d0b6d299f30ed89b03511deb9.png"
                      />
                      Gói 2: Giao thứ 4, trước 19h, 25/10
                    </div>
                  </div>
                  <div className={cx("left-content")}>
                    <div className={cx("package-summary")}>
                      ...
                      <div className={cx("shipping-fee")}>
                        <span className={cx("original-fee")}>42.000 ₫</span>
                        <span className={cx("current-fee")}>22.300 ₫</span>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="14"
                          height="14"
                    ...
                    <div className={cx("package-item-list")}>
                      <div>
                        <div className={cx("package-item")}>
                          <div className={cx("item-icon")}>
                            <img
                              src="https://salt.tikicdn.com/cache/96x96/ts/product/11/13/de/d500a772339882fd6660b3004da9733c.jpg"
                              alt="icon"
                              width="48"
                              height="48"
                              srcSet="https://salt.tikicdn.com/cache/96x96/ts/product/11/13/de/d500a772339882fd6660b3004da9733c.jpg"
                              className="WebpImg__StyledImg-sc-h3ozu8-0 fWjUGo"
                            />
                          </div>
                          <div className={cx("item-info")}>
                            <div className={cx("item-info__first-line")}>
                              <span
                                className={cx("item-info__product-name")}
                                title="Apple iPhone 14 Pro Max 128GB Tím"
                              >
                                Apple iPhone 14 Pro Max 128GB Tím
                              </span>
                            </div>
                            <div className={cx("item-info__second-line")}>
                              <div className={cx("item-info__qty")}>SL: x2</div>
                              <div className={cx("item-info__price")}>
                                26.450.000 ₫
                              </div>
                            </div>
                  ...
                  <div className={cx("right-content")}>
                    <div className={cx("logistic-wrapper")}>
                      ...
                      <div>
                        ...
                        <p
                          className={cx(
                            "fulfillment-text fulfillment-text--warning"
                          )}
                        ></p>
                      </div>
                    </div>
          ...
          <div className={cx("right-content")}>
            ...
            <div className={cx("total-amount-area")}>
              <div className={cx("provisional")}>
                <span>Tạm tính</span>
                <span className={cx("price")}>{currencyFormat(10000)}</span>
              </div>
            ...
            <button className={cx("btnBtn")}>Đặt Hàng</button>
          </div>
        </div>
      </div>
    </div>
